CLI Task Manager with Data Export Capability
A practical Python-based Command-Line Interface (CLI) application designed to manage daily tasks efficiently. This project reflects my early journey in self-taught programming, focusing on core logic and data portability.
🚀 Key Features
 * Task Management: Create, view, mark as complete, and delete tasks seamlessly via interactive menu.
 * Data Persistence: Automatically saves tasks to a .txt file to ensure no data loss.
