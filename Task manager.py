...
def main():
    ...
    if len(sys.argv) > 1: # Jika ada argumen baris perintah
        cmd1 = sys.argv[1] # Perintah utama Ururtan : file(0) - cmd1(1) - opsi1(2) - cmd2(3) - opsi2(4)
        ...
        match cmd1:
            case "add":
                # Contoh: python ex_1_task_mgr.py add "Belajar Python" deadline 2025-12-31
                # sys.argv: [ex_1_task_mgr.py, "add", "Belajar Python", "deadline", "2025-12-31"]
            ...
            case "delete" | "complete": # Gabungkan karena logikanya mirip
                # Contoh: python ex_1_task_mgr.py delete 5
                # sys.argv: [ex_1_task_mgr.py, "delete", "5"]
            ...
            case "view":
                # Contoh: python ex_1_task_mgr.py view
                # sys.argv: [ex_1_task_mgr.py, "view"]
